  ...
  return (
    ...
    >
      <TextareaAutosize
        ...
        className="text-text-primary placeholder:text-text-tertiary m-0 w-full resize-none bg-transparent px-3 py-[13px] focus:outline-none disabled:cursor-not-allowed md:py-3.5"
      />
