    ...
    return (
      ...
      >
        <TextareaAutosize
          ...
          maxRows={maxRows}
          disabled={disabled}
          className="text-text-primary placeholder:text-text-secondary w-full resize-none bg-transparent px-1.5 py-1 text-sm focus:outline-none disabled:cursor-not-allowed"
        />
          ...
          <TooltipAnchor
            ...
            render={
              <button
                ...
                className="size-theme-control rounded-theme-control-round bg-text-primary p-theme-compact text-text-primary duration-theme-normal disabled:text-text-secondary outline-offset-4 transition-all disabled:cursor-not-allowed disabled:opacity-10"
              >
                <SendIcon size={24} />
              </button>
            }
