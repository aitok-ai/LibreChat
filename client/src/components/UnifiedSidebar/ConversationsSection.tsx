    ...
    >
      ...
      {isSmallScreen && (
        <div
          ...
          className="text-text-primary hover:bg-surface-active-alt flex w-full cursor-pointer items-center rounded-lg px-2.5 py-2 text-sm outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-inset dark:focus-visible:ring-white"
          onClick={() => {
