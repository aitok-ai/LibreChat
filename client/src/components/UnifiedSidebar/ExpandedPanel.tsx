    ...
    <TooltipAnchor
      ...
      render={
        <a
          ...
          onClick={handleClick}
        >
          <div className="bg-text-primary flex size-6 items-center justify-center rounded-full">
...
function ExpandedPanel({
  ...
  return (
    <div className="border-border-light bg-surface-primary-alt flex h-full flex-shrink-0 flex-col gap-2 border-r px-2 py-2">
      <TooltipAnchor
        side="right"
