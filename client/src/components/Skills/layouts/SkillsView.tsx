...
export default function SkillsView() {
  ...
  if (!rolesLoaded) {
    return (
      <div className="bg-presentation flex h-full w-full items-center justify-center">
  ...
  if (!skillId) {
    return (
      <div className="bg-presentation flex h-full w-full flex-col items-center justify-center">
        <SkillState
...
function DetailView({ skillId }: { skillId: string }) {
  ...
  if (activeFile) {
    return (
      <div className="bg-presentation flex h-full w-full flex-col">
...
function EditView({ skillId }: { skillId: string }) {
  return (
    <div className="bg-presentation flex h-full w-full flex-col overflow-y-auto">
