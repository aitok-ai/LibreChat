        ...
        >
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              autoComplete="off"
              className="border-border-medium text-text-primary placeholder:text-text-secondary focus-visible:ring-ring-primary flex h-10 w-full rounded-xl border bg-transparent px-3 py-2 text-sm focus-visible:ring-2 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50"
              {...register('name', {
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <TextareaAutosize
              ...
              className="border-border-medium text-text-primary placeholder:text-text-secondary focus-visible:ring-ring-primary w-full resize-none rounded-xl border bg-transparent px-3 py-2 text-sm focus-visible:ring-2 focus-visible:outline-none"
          ...
          {/* Instructions (body) */}
          <div className="flex flex-col gap-1.5">
            <label htmlFor="create-skill-body" className="text-text-secondary text-sm font-medium">
