          ...
          <TooltipAnchor
            ...
            render={
              <Ariakit.MenuButton
                ...
                className="border-border-light text-text-primary hover:bg-surface-hover focus-visible:ring-text-primary inline-flex size-9 shrink-0 items-center justify-center rounded-lg border bg-transparent transition-colors focus:outline-none focus-visible:ring-2"
              >
