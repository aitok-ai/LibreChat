    ...
    <div className="bg-presentation flex h-full flex-col" onKeyDown={handleKeyDown}>
      ...
      <div className="relative flex-1 overflow-hidden">
        <textarea
          ...
          spellCheck={false}
          className={cn(
            'text-text-primary focus-visible:ring-ring-primary size-full resize-none bg-transparent px-4 py-3 font-mono text-[13px] leading-6 outline-none focus-visible:ring-2 focus-visible:ring-inset',
