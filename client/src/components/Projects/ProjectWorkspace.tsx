...
export default function ProjectWorkspace() {
  ...
  return (
    <main className="bg-surface-primary text-text-primary flex h-full min-h-0 flex-col overflow-y-auto">
      <div className="mx-auto flex w-full max-w-3xl flex-1 flex-col px-4 pt-4 pb-10 md:px-6 lg:pt-8">
        <button
          type="button"
          onClick={() => navigate('/projects')}
          className="text-text-secondary hover:bg-surface-hover hover:text-text-primary focus-visible:ring-ring-primary -ml-1.5 inline-flex w-fit items-center gap-1.5 rounded-lg px-2 py-1 text-sm transition-colors focus-visible:ring-2 focus-visible:outline-none"
        >
        ...
        <header className="mt-5 flex items-start gap-3">
          <span className="bg-surface-secondary text-text-secondary flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl">
            <Folder className="h-6 w-6" aria-hidden="true" />
          </span>
          <div className="min-w-0 flex-1 pt-0.5">
            <h1 className="text-text-primary truncate text-2xl font-semibold tracking-tight">
              {project.name}
            </h1>
            {project.description ? (
        ...
        <button
          ...
          className={cn(
            'border-border-medium bg-surface-secondary mt-6 flex w-full items-center gap-3 rounded-[26px] border px-3.5 py-3 text-left shadow-sm transition-colors',
            'hover:bg-surface-tertiary focus-visible:ring-ring-primary focus-visible:ring-2 focus-visible:outline-none',
          )}
          aria-label={localize('com_ui_new_chat_in_project', { name: project.name })}
        >
          <span className="bg-surface-tertiary text-text-primary flex h-8 w-8 shrink-0 items-center justify-center rounded-full">
            ...
            <DropdownPopup
              ...
              trigger={
                <Ariakit.MenuButton
                  ...
                  className={cn(
                    'text-text-secondary hover:bg-surface-hover hover:text-text-primary focus-visible:ring-ring-primary inline-flex h-8 items-center justify-center gap-1.5 rounded-lg px-2.5 text-sm font-medium whitespace-nowrap transition-colors focus-visible:ring-2 focus-visible:outline-none',
