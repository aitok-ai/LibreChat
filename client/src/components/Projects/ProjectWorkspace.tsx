          ...
          <div className="min-w-0 flex-1 pt-0.5">
            ...
            {project.description ? (
              ...
              <button
                ...
                className="text-text-tertiary hover:text-text-primary focus-visible:ring-text-primary mt-1 text-sm transition-colors focus-visible:ring-2 focus-visible:outline-none"
              >
            ...
            <DropdownPopup
              ...
              trigger={
                <Ariakit.MenuButton
                  ...
                  className={cn(
                    'text-text-secondary hover:bg-surface-hover hover:text-text-primary focus-visible:ring-text-primary inline-flex h-8 items-center justify-center gap-1.5 rounded-lg px-2.5 text-sm font-medium whitespace-nowrap transition-colors focus-visible:ring-2 focus-visible:outline-none',
