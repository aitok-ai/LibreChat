    ...
    <>
      <OGDialog>
        ...
        <OGDialogContent
          className={
            dialogContentClassName ??
            'border-border-light bg-surface-dialog text-text-primary w-11/12 max-w-lg'
          }
        >
          <OGDialogTitle>
          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownPopup
              ...
              trigger={
                <Ariakit.MenuButton className="border-border-light text-text-primary hover:bg-surface-tertiary inline-flex min-w-[6rem] items-center justify-center rounded-lg border bg-transparent px-2 py-1 transition-all ease-in-out">
                  {selectedRole}
                </Ariakit.MenuButton>
              }
                  ...
                  <div key={permission}>
                    ...
                    {showAdminWarning &&
                      ...
                      permission === Permissions.USE && (
                        <div className="text-text-destructive mb-2 max-w-full text-sm break-words whitespace-normal">
