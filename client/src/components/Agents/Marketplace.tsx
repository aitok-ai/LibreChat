      ...
      <SidePanelGroup>
        <main className="flex h-full flex-col overflow-hidden" role="main">
          ...
          <div
            ...
            className="relative flex h-full scrollbar-gutter-stable flex-col overflow-x-hidden overflow-y-auto"
          >
            ...
            <div className="bg-presentation sticky top-0 z-10 mt-4 pb-4 md:mt-0">
