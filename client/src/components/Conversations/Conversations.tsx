      ...
      >
        ...
        {onRetry && (
          <button
            type="button"
            onClick={onRetry}
            className="text-text-primary focus-visible:ring-text-primary rounded-lg px-2 py-1 text-sm underline-offset-2 hover:underline focus-visible:ring-2 focus-visible:outline-none"
          >
