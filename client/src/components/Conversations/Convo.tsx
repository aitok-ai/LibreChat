...
function Conversation({
  ...
  const generatingSpinner = (
    <span role="img" aria-label={localize('com_ui_generating')}>
      <Spinner className="text-text-primary h-5 w-5 flex-shrink-0" />
    </span>
  );
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        'group focus-visible:ring-text-primary relative flex h-12 w-full items-center rounded-lg outline-none focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-inset md:h-9',
