        ...
        <div className="absolute inset-0 z-20 flex w-full items-center rounded-lg bg-gray-200 p-1.5 dark:bg-gray-700">
          ...
          <div className="flex gap-1">
            <button onClick={cancelRename}>
              <X className="h-4 w-4 transition-colors duration-200 ease-in-out hover:opacity-70" />
            </button>
            <button onClick={onRename}>
              <Check className="h-4 w-4 transition-colors duration-200 ease-in-out hover:opacity-70" />
            </button>
          </div>
        </div>
      ) : (
