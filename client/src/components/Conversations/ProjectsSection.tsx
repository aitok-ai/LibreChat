      ...
      <li className="list-none">
        ...
        >
          <button
            ...
            className="focus-visible:ring-text-primary flex min-w-0 flex-1 items-center gap-2 rounded-lg py-1.5 pr-16 pl-1.5 text-left outline-none focus-visible:ring-2 focus-visible:ring-inset"
          >
            <ChevronRight
              className={cn(
  ...
  return (
    <div className="flex flex-col px-3 text-sm">
      ...
      <Collapse open={isExpanded}>
        <div className="max-h-[42vh] scrollbar-gutter-stable overflow-y-auto pt-0.5">
          {renderProjectsBody()}
        </div>
      </Collapse>
