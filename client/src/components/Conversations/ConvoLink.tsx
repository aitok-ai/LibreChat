...
const ConvoLink: React.FC<ConvoLinkProps> = ({
  ...
  return (
    <button
      type="button"
      className={cn(
        'focus-visible:ring-text-primary flex w-full min-w-0 grow cursor-pointer items-center gap-2 overflow-hidden rounded-lg px-2 text-left outline-none focus-visible:ring-2 focus-visible:ring-inset',
