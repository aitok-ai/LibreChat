...
export default function SchedulePanel() {
  ...
  if (isError) {
    ...
    panelContent = (
      <div className="border-border-light rounded-lg border border-dashed p-4 text-center">
        <p className="text-text-secondary text-sm">{localize('com_ui_schedules_empty')}</p>
      </div>
    );
  } else {
    panelContent = (
