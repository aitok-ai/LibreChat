                ...
                <OGDialog>
                  <OGDialogTrigger asChild>
                    <button
                      ...
                      className="border-border-light hover:bg-surface-secondary focus-visible:ring-ring-primary inline-flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl border text-red-500 transition-colors focus:outline-none focus-visible:ring-2 disabled:opacity-50"
                    >
                  ...
                  <OGDialogTemplate
                    ...
                    selection={{
                      ...
                      selectClasses:
                        'bg-surface-destructive hover:bg-surface-destructive-hover transition-color duration-200 text-text-on-status',
