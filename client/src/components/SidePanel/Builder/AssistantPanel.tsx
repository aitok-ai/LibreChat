    ...
    <FormProvider {...methods}>
      ...
      >
        <div className="flex w-full flex-wrap">
          ...
          {assistant_id && (
            <button
              className="btn bg-surface-submit text-text-on-status hover:bg-surface-submit-hover focus-visible:ring-text-primary focus-visible:ring-offset-surface-primary mx-2 mt-1 h-[40px] rounded px-4 py-2 font-semibold focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
              type="button"
        ...
        <div className="bg-surface-primary h-auto px-4 pt-3 pb-8 dark:bg-transparent">
          ...
          <div className="flex items-center justify-end gap-2">
            ...
            {/* Submit Button */}
            <button
              className="btn bg-surface-submit text-text-on-status hover:bg-surface-submit-hover focus-visible:ring-text-primary focus-visible:ring-offset-surface-primary flex w-full items-center justify-center px-4 py-2 font-semibold focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
              type="submit"
            >
              {submitContext}
            </button>
