    ...
    <>
      <div className="flex min-h-0 flex-1 flex-col">
        <div className="mb-1 flex flex-wrap items-center justify-between gap-4">
          <label
            htmlFor="schemaInput"
            className="text-token-text-primary text-sm font-medium whitespace-nowrap"
          >
        ...
        <div className="border-token-border-medium bg-token-surface-primary hover:border-token-border-hover mb-4 flex min-h-0 flex-1 flex-col overflow-hidden rounded-lg border ring-0">
          <div className="relative flex min-h-0 flex-1 flex-col">
            <textarea
              ...
              className="text-token-text-primary focus:ring-border-light block min-h-[12rem] flex-1 resize-y bg-transparent p-2 font-mono text-xs outline-none focus:ring-1"
            />
          </div>
      ...
      <div className="mt-auto flex items-center justify-end pt-2">
        <button
          ...
          onClick={saveAction}
          className="focus:shadow-outline flex min-w-[100px] items-center justify-center rounded bg-green-500 px-4 py-2 font-semibold text-white hover:bg-green-400 focus:border-green-500 focus:ring-0 focus:outline-none disabled:bg-green-400"
          type="button"
        >
          {getButtonContent()}
        </button>
