          ...
          <DropdownPopup
            ...
            trigger={
              <Menu.MenuButton
                ...
                className="border-border-medium bg-surface-secondary text-text-primary hover:bg-surface-tertiary flex h-7 items-center gap-1 rounded-md border px-2 py-0 text-sm transition-colors duration-200"
              >
