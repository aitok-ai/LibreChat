  ...
  return (
    <div className="mb-1 flex w-full flex-col gap-3 text-sm">
      ...
      <button
        ...
        className="border-border-light text-text-secondary hover:bg-surface-secondary hover:text-text-primary focus-visible:ring-ring-primary mt-2 inline-flex h-9 w-full items-center justify-center gap-2 rounded-xl border bg-transparent px-4 text-sm font-medium transition-colors focus:outline-none focus-visible:ring-2"
      >
