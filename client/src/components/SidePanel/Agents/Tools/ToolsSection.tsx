          ...
          <div className="mb-1.5 flex items-center justify-between gap-3 px-1">
            <div className="flex min-w-0 items-center gap-1.5">
              <span
                ...
                className="text-text-primary truncate text-[13px] font-medium"
              >
    ...
    <div className="mb-3 flex flex-col">
      <div className="mb-1 flex items-center justify-between">
        ...
        <button
          ...
          className={`text-text-secondary hover:bg-surface-secondary hover:text-text-primary inline-flex h-7 items-center gap-1.5 rounded-lg px-2 text-xs font-medium transition focus:outline-none focus-visible:ring-2 focus-visible:ring-ring-primary${!showAdd ? 'pointer-events-none opacity-0' : ''}`}
        >
