    ...
    <div className="mb-3 flex flex-col">
      <div className="mb-1 flex items-center justify-between">
        ...
        <button
          ...
          onClick={onAdd}
          aria-label={addLabel}
          className="text-text-secondary hover:bg-surface-secondary hover:text-text-primary focus-visible:ring-ring-primary inline-flex h-7 items-center gap-1.5 rounded-lg px-2 text-xs font-medium transition focus:outline-none focus-visible:ring-2"
        >
