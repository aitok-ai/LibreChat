        ...
        {currentAgentId && (
          <div className="border-border-light flex items-center justify-between gap-2 border-t pt-3">
            ...
            <button
              ...
              className="text-text-secondary hover:bg-surface-secondary hover:text-text-primary focus-visible:ring-ring-primary inline-flex items-center gap-1.5 rounded-lg px-2 py-1 transition-colors focus:outline-none focus-visible:ring-2"
            >
