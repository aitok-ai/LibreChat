    ...
    <div className="mb-1 flex w-full flex-col gap-4 text-sm">
      <header className="grid grid-cols-[auto_1fr_auto] items-center gap-2 pt-1">
        <Button
          ...
          className="border-border-light text-text-secondary hover:bg-surface-secondary hover:text-text-primary focus-visible:ring-text-primary h-10 w-10 flex-shrink-0 rounded-xl border focus:outline-none focus-visible:ring-2"
        >
            ...
            <TooltipAnchor
              ...
              render={
                <Button
                  ...
                  className="text-text-secondary hover:bg-surface-secondary hover:text-text-primary focus-visible:ring-text-primary h-auto gap-1.5 rounded-lg px-2 py-1 focus:outline-none focus-visible:ring-2"
                >
