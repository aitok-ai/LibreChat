  ...
  return (
    <div
      className={cn(
        ...
        'focus-within:ring-ring focus-within:ring-offset-background mr-1 ml-2 focus-within:ring-2 focus-within:ring-offset-2',
    ...
    >
      <Checkbox
        ...
        onClick={(e) => e.stopPropagation()}
        className="border-border-medium hover:border-border-heavy focus:ring-ring focus:ring-offset-background relative mr-2 inline-flex h-4 w-4 shrink-0 cursor-pointer rounded border transition-[border-color] duration-200 focus:ring-2 focus:ring-offset-2 focus:outline-none"
        aria-label={tool.metadata.name}
      />
      <span className="text-token-text-primary min-w-0 flex-1 truncate select-none">
        {tool.metadata.name}
      </span>
      <div className="ml-2 flex shrink-0 items-center gap-1.5">
        ...
        <DropdownMenu>
            ...
            <button
              ...
              className={cn(
                ...
                hasOptions
                  ...
                  : 'text-text-tertiary hover:bg-surface-hover hover:text-text-primary opacity-0 group-focus-within/item:opacity-100 group-hover/item:opacity-100',
              )}
              onClick={(e) => e.stopPropagation()}
          ...
          <DropdownMenuContent
            ...
            onClick={(e) => e.stopPropagation()}
          >
            <DropdownMenuLabel className="text-text-primary text-xs font-normal">
