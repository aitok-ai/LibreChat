    ...
    <OGDialog>
      <Accordion type="single" value={accordionValue} onValueChange={setAccordionValue} collapsible>
        <AccordionItem value={currentServerName} className="group relative w-full border-none">
          <div
            className="focus-within:bg-surface-primary-alt hover:bg-surface-primary-alt relative flex w-full items-center gap-1 rounded-lg p-1 text-sm"
              ...
              >
                ...
                <div className="flex items-center">
                  <div className="relative flex items-center">
                    <div
                      className={cn(
                        'bg-surface-primary-alt absolute right-0 rounded-md py-0.5 pl-1 transition-all duration-300',
