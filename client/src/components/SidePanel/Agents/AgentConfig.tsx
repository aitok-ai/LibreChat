      ...
      <div className="h-auto pt-1">
        ...
        {showSkills && (
          <div className="mb-4">
            ...
            <p className="text-text-secondary mb-2 text-xs">{localize(skillsHintKey)}</p>
            <div
              ...
              <div className="mb-1">
                {(skills ?? []).map((skillId) => {
                  ...
                  return (
                    <div
                      key={skillId}
                      className="border-border-light mb-1 flex items-center justify-between rounded-md border px-3 py-2 text-sm"
                    >
                      <span className="text-text-primary truncate">{skillName}</span>
                      <button
                        type="button"
                        onClick={() => {
                        ...
                        className="text-text-secondary hover:text-text-primary ml-2 flex-shrink-0 transition-colors"
