    ...
    <TooltipAnchor
      ...
      render={
        <button
          ...
          aria-label={label}
          className={cn(
            'hover:bg-surface-hover focus-visible:ring-ring-primary flex items-center justify-center rounded-md transition-colors focus:outline-none focus-visible:ring-2',
