  ...
  return (
    <div id="prompts-panel" className={cn('flex h-full w-full flex-col', className)}>
      ...
      <div className="relative flex min-h-0 flex-1 flex-col">
        <div className="scrollbar-gutter-stable text-text-primary flex h-full min-h-0 flex-col gap-2 overflow-x-hidden overflow-y-auto pr-1 pl-3">
        ...
        <div
          className={cn(
            'from-surface-primary-alt pointer-events-none inset-x-0 bottom-0 bg-gradient-to-t from-60% to-transparent px-3 pb-2',
          )}
        >
