        ...
        {isSmallerScreen && isDetailView ? (
          <div className="mt-2 mr-2 flex h-10 items-center justify-between">
            <button
              ...
              type="button"
              onClick={togglePanel}
              className="border-border-medium bg-surface-primary text-text-primary hover:bg-surface-hover ml-2 flex h-8 w-8 items-center justify-center rounded-lg border transition-all"
