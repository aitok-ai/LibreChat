      ...
      <form onSubmit={handleSubmit(onSubmit)} className="w-full px-4 py-2">
              ...
              render={({ field }) => (
                <div className="relative mb-1 flex w-full flex-col sm:w-auto md:mb-0">
                  <Input
                    ...
                    id="prompt-name"
                    type="text"
                    className="peer border-border-light text-text-primary mr-2 w-full border p-2 text-2xl"
                    placeholder=" "
                    tabIndex={0}
                  ...
                  <label
                    htmlFor="prompt-name"
                    className="bg-surface-primary text-text-secondary peer-focus:text-text-primary pointer-events-none absolute -top-1 left-3 origin-[0] translate-y-3 scale-100 rounded px-1 text-base transition-transform duration-200 peer-placeholder-shown:translate-y-3 peer-placeholder-shown:scale-100 peer-focus:-translate-y-2 peer-focus:scale-75 peer-[:not(:placeholder-shown)]:-translate-y-2 peer-[:not(:placeholder-shown)]:scale-75"
                  >
        ...
        <div className="flex w-full flex-col gap-4 md:mt-[1.075rem]">
          <div className="flex flex-col">
            <header className="border-border-light flex items-center justify-between rounded-t-xl border bg-transparent p-2">
            ...
            <div className="border-border-light min-h-32 rounded-b-xl border border-t-0 p-3 sm:p-4">
              <Controller
                name="prompt"
                control={control}
