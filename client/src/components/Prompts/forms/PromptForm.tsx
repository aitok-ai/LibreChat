...
const VersionsPanel = React.memo(
  ({
    ...
    return (
      <div
        className="bg-surface-primary flex h-full w-full flex-col overflow-hidden"
        style={{ maxHeight: 'calc(100vh - 100px)' }}
      >
        {canEdit && (
          <div className="border-border-light shrink-0 border-b px-4 py-3">
            <Button
              variant="submit"
              size="sm"
        ...
        <div className="relative w-full">
          <div className="h-full w-full">
            <div className="flex h-full">
              ...
              {editorMode === PromptsEditorMode.ADVANCED && (
                <div className="border-border-light hidden w-72 shrink-0 border-l lg:block xl:w-80">
                  <VersionsPanel
                    group={group}
                    prompts={prompts}
                    selectionIndex={selectionIndex}
          ...
          <div
            ...
            aria-label={localize('com_ui_versions')}
          >
            <div className="bg-surface-primary h-full shadow-xl">
