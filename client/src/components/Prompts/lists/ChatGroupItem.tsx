...
function ChatGroupItem({ group }: { group: TPromptGroup }) {
  ...
  return (
    <>
      <div className="border-border-light hover:bg-surface-secondary mb-2 rounded-xl border bg-transparent px-1">
        <ListCard
          name={group.name}
          ...
          <div className="flex items-center gap-1">
            <TooltipAnchor
              ...
              render={
                ...
                >
                  <Eye className="text-text-primary size-4" aria-hidden="true" />
                </Button>
              }
            />
            {canEdit && (
