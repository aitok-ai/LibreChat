...
function DashGroupItemComponent({ group }: { group: TPromptGroup }) {
  ...
  return (
    <article
      className={cn(
        'group/card border-border-light hover:bg-surface-secondary relative flex w-full items-center overflow-hidden rounded-lg border bg-transparent text-left',
    ...
    >
      <div className="flex w-0 min-w-0 flex-1 items-center gap-2 overflow-hidden p-4">
        ...
        <a
          ...
          className="text-text-primary focus-visible:ring-ring-primary min-w-0 flex-1 truncate text-base font-semibold after:absolute after:inset-0 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
          title={group.name}
          ...
          <TooltipAnchor
            ...
            render={
              <span
                ...
                className="focus-visible:ring-ring-primary flex shrink-0 cursor-default items-center rounded-sm focus:outline-none focus-visible:ring-2"
              >
            ...
            <OGDialogTrigger asChild>
              <TooltipAnchor
                ...
                render={
                  ...
                  >
                    <Pencil className="text-text-primary size-4" aria-hidden="true" />
                  </Button>
                }
              />
            </OGDialogTrigger>
            ...
            <OGDialogTrigger asChild>
              <TooltipAnchor
                ...
                render={
                  ...
                  >
                    <Trash2 className="text-text-primary size-4" aria-hidden="true" />
                  </Button>
                }
              />
            </OGDialogTrigger>
