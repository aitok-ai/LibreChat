          ...
          return (
            <div className="flex items-center gap-2">
              ...
              <Link
                ...
                className="group text-link focus-visible:ring-text-primary flex items-center gap-1 truncate rounded-sm underline decoration-1 underline-offset-2 hover:decoration-2 focus-visible:ring-2 focus-visible:outline-none"
    ...
    <>
      ...
      <div className="h-[60vh]">
        <VirtualizedDataTable
          ...
          className="h-full max-h-none scrollbar-gutter-stable"
