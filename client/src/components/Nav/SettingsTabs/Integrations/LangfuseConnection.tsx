    ...
    <div className="flex flex-col gap-4">
      <Popover>
          ...
          <div className="flex min-w-0 flex-1 flex-wrap items-center gap-2">
            ...
            <PopoverTrigger asChild>
              <button
                ...
                className="text-text-tertiary hover:bg-surface-hover hover:text-text-primary focus-visible:ring-text-primary inline-flex size-6 items-center justify-center rounded-md transition-colors focus-visible:ring-2 focus-visible:outline-none"
              >
        ...
        <PopoverPortal>
          <PopoverContent
            side="top"
            sideOffset={6}
            className="border-border-light bg-surface-secondary text-text-primary z-[999] w-80 rounded-xl border p-4 shadow-md outline-none"
          >
      ...
      <div className="flex flex-col gap-1.5">
        ...
        {secretConfigured && !isEditingPublicKey && (
          <button
            type="button"
            className="border-border-light hover:border-border-medium focus-visible:ring-ring-primary w-full rounded-lg border px-3 py-2 text-left focus-visible:ring-2 focus-visible:outline-none"
