                  ...
                  {user?.backupCodes.map((code, index) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className={`focus-visible:ring-text-primary flex flex-col rounded-xl border p-4 backdrop-blur-sm transition-colors focus-visible:ring-2 focus-visible:outline-none ${
                          isUsed
