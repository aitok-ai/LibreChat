    ...
    <div className="flex items-center justify-between">
      ...
      <OGDialog open={open} onOpenChange={setOpen}>
        ...
        <OGDialogContent
          ...
          className="bg-surface-dialog text-text-primary focus-visible:ring-text-primary w-11/12 max-w-2xl shadow-2xl focus:outline-none focus-visible:ring-2 focus-visible:ring-inset"
