          ...
          render={
            <Ariakit.MenuButton
              ...
              className={cn(
                ...
                'text-text-primary hover:bg-accent hover:text-accent-foreground size-10 border-none',
                'hover:bg-surface-active-alt rounded-full border-none p-2 md:rounded-xl',
