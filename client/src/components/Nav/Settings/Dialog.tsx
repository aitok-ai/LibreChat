      ...
      <Dialog as="div" className="relative z-50" onClose={() => onOpenChange(false)}>
        ...
        >
          <div className="fixed inset-0 flex w-screen items-center justify-center p-4">
            <DialogPanel
              className={cn(
                'bg-background flex max-h-[85vh] w-full flex-col overflow-hidden rounded-2xl shadow-2xl',
              ...
              >
                {inDetail ? (
                  <button
                    ...
                    className="text-text-primary hover:bg-surface-hover focus:ring-border-xheavy -ml-1 flex items-center gap-1 rounded-lg p-1 transition-colors focus:ring-2 focus:outline-none"
                ...
                <button
                  ...
                  className="text-text-secondary hover:bg-surface-hover hover:text-text-primary focus:ring-border-xheavy rounded-lg p-1 transition-colors focus:ring-2 focus:outline-none"
                >
