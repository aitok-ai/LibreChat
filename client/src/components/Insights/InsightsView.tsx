        ...
        <div className="flex max-w-full flex-wrap items-center gap-2 md:flex-nowrap">
          {data && (
            <MultiSelect
              ...
              popoverHeader={
                <div className="border-border-light border-b pb-2">
                  <Button
                    type="button"
                    size="sm"
                    variant="ghost"
                    className="text-text-secondary hover:bg-surface-hover hover:text-text-primary h-8 w-full justify-start rounded-none px-4 font-normal"
