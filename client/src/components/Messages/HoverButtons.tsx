...
export default function HoverButtons({
  ...
  return (
    <div className="visible mt-2 flex justify-center gap-3 self-end text-gray-400 md:gap-4 lg:absolute lg:top-0 lg:right-0 lg:mt-0 lg:translate-x-full lg:gap-1 lg:self-center lg:pl-2">
      <button
        className={cn(
          'hover-button rounded-md p-1 hover:bg-gray-200 hover:text-gray-700 md:invisible md:group-hover:visible dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-200 disabled:dark:hover:text-gray-400',
      ...
      {regenerateEnabled ? (
        <>
          ...
          <button
            className="hover-button active rounded-md p-1 hover:bg-gray-200 hover:text-gray-700 md:invisible md:group-hover:visible dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-200 disabled:dark:hover:text-gray-400"
            onClick={regenerate}
            type="button"
