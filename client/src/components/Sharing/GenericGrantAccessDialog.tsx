...
export default function GenericGrantAccessDialog({
    ...
    return (
      <TooltipAnchor
        ...
        render={
          ...
          >
            <div className="text-text-destructive flex min-w-[32px] items-center justify-center">
  ...
  const TriggerComponent = children ? (
    ...
    <Button
      ...
      className={cn('h-9', buttonClassName)}
    >
      <div className="text-status-info flex min-w-[32px] items-center justify-center gap-2">
        <span className="flex h-6 w-6 items-center justify-center">
