  ...
  return (
    <>
      ...
      <div className="flex justify-center">
        <Button
          type="button"
          className="text-text-primary hover:bg-surface-hover hover:text-text-primary mt-1 mr-2 h-auto items-center justify-center bg-transparent px-3 py-2 text-xs font-medium font-normal focus:ring-0 focus:ring-offset-0 dark:focus:ring-offset-0 dark:focus:outline-none"
        ...
        <Button
          type="button"
          className="text-text-primary hover:bg-surface-hover hover:text-text-primary mt-1 h-auto items-center justify-center bg-transparent px-3 py-2 text-xs font-medium font-normal focus:ring-0 focus:ring-offset-0 dark:focus:ring-offset-0 dark:focus:outline-none"
          onClick={addExample}
        >
