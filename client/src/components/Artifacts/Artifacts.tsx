        ...
        >
          {isMobile && !isFullscreen && (
            <div
              ...
              className="bg-surface-primary-alt focus-visible:ring-border-heavy flex flex-shrink-0 cursor-grab items-center justify-center pt-2.5 pb-1.5 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-inset active:cursor-grabbing"
          ...
          <div
            className={cn(
              'border-border-light bg-surface-primary-alt flex h-[52px] flex-shrink-0 items-center justify-between gap-2 border-b p-2 transition-all duration-300 motion-reduce:transition-none',
