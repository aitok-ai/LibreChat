  ...
  return (
    <div className="flex flex-col gap-1">
      <div
        ...
        className="border-border-light bg-surface-primary-alt focus-visible:ring-ring-primary relative h-[60px] cursor-crosshair touch-none overflow-hidden rounded-lg border select-none focus-visible:ring-2 focus-visible:outline-none"
      >
