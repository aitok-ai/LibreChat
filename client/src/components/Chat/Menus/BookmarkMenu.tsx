          ...
          <TooltipAnchor
            ...
            render={
              <Ariakit.MenuButton
                ...
                className={cn(
                  'mt-text-sm border-border-light bg-presentation hover:bg-surface-hover flex size-9 flex-shrink-0 items-center justify-center gap-2 rounded-xl border text-sm transition-colors duration-200',
