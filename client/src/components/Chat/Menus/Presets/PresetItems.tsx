            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button
                  ...
                  size="sm"
                  type="button"
                  className="text-text-secondary hover:text-text-destructive h-8 px-2 text-xs font-normal"
              ...
              <Close asChild key={`preset-${presetId}`}>
                <div key={`preset-${presetId}`}>
                  <Flipped flipId={presetId}>
                    <div className="group hover:bg-surface-hover m-1.5 flex items-center gap-2 rounded px-3 py-1.5 text-sm">
                      <Button
                        variant="ghost"
                        type="button"
                        ...
                        <TooltipAnchor
                          ...
                          render={
                            <Button
                              variant="ghost"
                              className={cn(
                                'text-text-tertiary hover:text-text-primary focus:text-text-primary m-0 h-full rounded-md bg-transparent p-2',
                                defaultPreset?.presetId === presetId
                                  ? ''
