                    ...
                    >
                      <div className="flex h-full items-center justify-end gap-1">
                        ...
                        <TooltipAnchor
                          ...
                          render={
                            <button
                              className="m-0 h-full rounded-md p-2 text-gray-400 hover:text-gray-700 focus:text-gray-700 sm:pointer-events-none sm:opacity-0 sm:transition-opacity sm:group-focus-within:pointer-events-auto sm:group-focus-within:opacity-100 sm:group-hover:pointer-events-auto sm:group-hover:opacity-100 sm:focus:pointer-events-auto sm:focus:opacity-100 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:text-gray-200"
                              onClick={(e) => {
                                e.preventDefault();
                                e.stopPropagation();
                        ...
                        <TooltipAnchor
                          ...
                          render={
                            <button
                              className="m-0 h-full rounded-md p-2 text-gray-400 hover:text-gray-600 focus:text-gray-600 sm:pointer-events-none sm:opacity-0 sm:transition-opacity sm:group-focus-within:pointer-events-auto sm:group-focus-within:opacity-100 sm:group-hover:pointer-events-auto sm:group-hover:opacity-100 sm:focus:pointer-events-auto sm:focus:opacity-100 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:text-gray-200"
                              onClick={(e) => {
                                e.preventDefault();
                                e.stopPropagation();
