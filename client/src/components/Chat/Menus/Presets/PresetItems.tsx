...
const PresetItems: FC<{
  ...
  return (
    <>
      <div
        role="menuitem"
        className="pointer-none group radix-disabled:pointer-events-none radix-disabled:opacity-50 m-1.5 flex h-8 min-w-[170px] gap-2 rounded px-5 py-2.5 !pr-3 text-sm !opacity-100 focus:ring-0 md:min-w-[240px]"
        tabIndex={-1}
      >
        <div className="flex h-full grow items-center justify-end gap-2">
          <label
            htmlFor="default-preset"
            className="w-40 truncate rounded bg-transparent py-1 text-xs font-medium text-gray-600 transition-colors sm:w-72 dark:bg-transparent dark:text-gray-300"
          >
            {defaultPreset
          ...
          <Dialog>
            <DialogTrigger asChild>
              <button
                type="button"
                className="focus:ring-ring mr-1 flex h-[32px] cursor-pointer items-center rounded bg-transparent px-2 py-1 text-xs font-medium text-gray-600 transition-colors hover:bg-gray-100 hover:text-red-700 dark:bg-transparent dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-red-700"
                    ...
                    >
                      <div className="flex h-full items-center justify-end gap-1">
                        ...
                        <TooltipAnchor
                          ...
                          render={
                            <button
                              className="m-0 h-full rounded-md p-2 text-gray-400 hover:text-gray-700 focus:text-gray-700 sm:invisible sm:group-focus-within:visible sm:group-hover:visible dark:text-gray-400 dark:hover:text-gray-200 dark:focus:text-gray-200"
                              onClick={(e) => {
                                e.preventDefault();
                                e.stopPropagation();
                        ...
                        <TooltipAnchor
                          ...
                          render={
                            <button
                              className="m-0 h-full rounded-md p-2 text-gray-400 hover:text-gray-600 focus:text-gray-600 sm:invisible sm:group-focus-within:visible sm:group-hover:visible dark:text-gray-400 dark:hover:text-gray-200 dark:focus:text-gray-200"
                              onClick={(e) => {
                                e.preventDefault();
                                e.stopPropagation();
