      ...
      <Collapsible open={expanded} onOpenChange={setExpanded}>
        <CollapsibleTrigger asChild>
          <Button
            type="button"
            variant="ghost"
            className="text-text-secondary hover:text-text-primary h-auto min-h-6 w-full justify-start gap-1.5 px-0 text-left text-xs font-medium hover:bg-transparent"
          >
            <TriggerIcon kind="external_event" />
            <span>{label}</span>
