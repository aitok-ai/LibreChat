...
export default function SubagentThreadPanel({ selection }: { selection: ActiveSubagentPanel }) {
  ...
  if (hasEarlierRetainedTasks) {
    ...
    timelinePrefix = (
      <div
        role="note"
        className="border-border-light text-text-secondary border-b px-4 py-3 text-sm"
      >
  ...
  return (
    <aside
      ...
      className="bg-surface-primary-alt text-text-primary flex h-full w-full flex-col overflow-hidden"
    >
      <header className="border-border-light flex min-h-14 shrink-0 items-center gap-3 border-b px-4 py-3">
        <div className="bg-surface-tertiary flex h-8 w-8 shrink-0 items-center justify-center rounded-full">
      ...
      {selection.event != null && (
        <div className="border-border-light flex shrink-0 items-center gap-2 border-b px-4 py-2">
          <div className="min-w-0 flex-1">
      ...
      {showControlFooter && (
        <div className="border-border-light shrink-0 border-t p-3">
            ...
            <>
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                ...
                <Button
                  ...
                  className="text-status-error ml-auto"
                >
