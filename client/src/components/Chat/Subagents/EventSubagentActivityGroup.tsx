        ...
        {eventChildren.map((child) => {
          ...
          return (
            <button
              ...
              className={cn(
                'focus-visible:ring-ring-primary flex w-full items-center gap-2 px-3 py-2 text-left text-sm focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-inset',
