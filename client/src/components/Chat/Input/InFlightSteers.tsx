      ...
      <div className="flex max-w-full items-center gap-1.5">
        <div
          className={cn(
            ...
            'border-border-medium flex min-w-0 items-start gap-2 rounded-3xl border',
            'bg-surface-secondary text-text-primary py-2 pr-4 pl-3 text-sm',
            sending && 'opacity-70',
          )}
        >
        ...
        {!sending && (
          ...
          <button
            ...
            className="text-text-secondary hover:bg-surface-tertiary hover:text-text-primary focus-visible:ring-border-xheavy shrink-0 rounded-full p-1 transition-opacity duration-200 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:outline-none [@media(hover:hover)]:opacity-0"
          >
