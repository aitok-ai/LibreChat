          ...
          <div className="flex min-w-0 flex-col items-start gap-1">
            ...
            {overflowing && (
              <button
                ...
                className="text-text-secondary hover:text-text-primary focus-visible:ring-border-xheavy inline-flex items-center gap-1 rounded text-xs font-medium focus-visible:ring-2 focus-visible:outline-none"
              >
                {expanded ? (
