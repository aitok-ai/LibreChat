...
function AskUserQuestionsPopoverPanel({ ask }: { ask: ReturnType<typeof useAskAnswerMode> }) {
  ...
  return (
    <div className="absolute bottom-28 z-10 w-full">
      <div className="popover border-token-border-light bg-surface-primary-alt flex max-h-[70vh] flex-col rounded-2xl border shadow-lg">
...
function AskUserQuestionPopoverPanel({
  ...
  return (
    <div className="absolute bottom-28 z-10 w-full space-y-2">
      ...
      <div
        className="popover border-token-border-light bg-surface-primary-alt flex max-h-[60vh] flex-col rounded-2xl border p-2 shadow-lg"
      ...
      >
          ...
          {options.map((option, index) => {
            ...
            return (
              <Button
                ...
                className={cn(
                  'mt-1 h-auto min-h-9 w-full justify-start gap-3 p-2 text-left whitespace-normal',
                ...
                <span
                  className={cn(
                    ...
                    isChecked
                      ...
                      : 'border-border-xheavy text-text-secondary border',
                  )}
                >
        ...
        <div className="flex shrink-0 items-center justify-between gap-2 p-2">
          <button
            type="button"
            className="text-text-secondary hover:text-text-primary text-xs italic hover:underline"
