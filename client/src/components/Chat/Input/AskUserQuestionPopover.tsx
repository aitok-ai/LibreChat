    ...
    <div className="absolute bottom-28 z-10 w-full space-y-2">
      ...
      >
        <div className="flex items-start justify-between gap-2 p-2">
          <div>
            <p className="text-text-primary text-sm font-medium">{liveAsk.question.question}</p>
            {liveAsk.question.description != null && liveAsk.question.description.length > 0 && (
              <p className="text-text-secondary mt-0.5 text-xs">{liveAsk.question.description}</p>
            )}
          </div>
        ...
        {options.map((option, index) => {
          ...
          return (
            <button
              ...
              disabled={locked}
              className={cn(
                'text-text-primary flex w-full items-center gap-3 rounded-lg p-2 text-left text-sm',
        ...
        {errored && (
          <div className="text-text-warning flex items-center gap-1.5 px-2 pt-1 text-xs">
