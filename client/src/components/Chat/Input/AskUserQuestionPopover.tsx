...
function AskUserQuestionPopoverPanel({
  ...
  return (
    <div className="absolute bottom-28 z-10 w-full space-y-2">
      ...
      <div
        className="popover border-token-border-light bg-surface-primary-alt flex max-h-[60vh] flex-col rounded-2xl border p-2 shadow-lg [view-transition-name:ask-question]"
