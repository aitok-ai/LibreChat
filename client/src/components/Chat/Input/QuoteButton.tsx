...
function QuoteButton({ conversationId }: { conversationId: string }) {
  ...
  return createPortal(
    <button
      ...
      className="border-border-light bg-surface-secondary text-text-primary hover:bg-surface-tertiary fixed z-50 inline-flex items-center gap-1.5 rounded-full border px-3 py-1.5 text-sm font-medium shadow-lg transition-colors"
    >
