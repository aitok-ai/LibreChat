      ...
      <div key={entry.key} role="none">
        <div role="none" className="flex items-center gap-0.5">
          ...
          <Ariakit.MenuItem
            ...
            hideOnClick={false}
            className="text-text-secondary hover:bg-surface-tertiary hover:text-text-primary focus-visible:ring-border-xheavy data-[active-item]:bg-surface-tertiary flex size-8 shrink-0 items-center justify-center rounded-lg focus-visible:ring-2 focus-visible:outline-none"
            onClick={() =>
