                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input
                      ...
                      className="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                    />
                  )}
                />
                {details.description && (
                  <p
                    className="text-text-secondary text-xs [&_a]:text-blue-500 [&_a]:hover:text-blue-600 dark:[&_a]:text-blue-400 dark:[&_a]:hover:text-blue-300"
