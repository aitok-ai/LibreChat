      ...
      {!isMulti ? (
        ...
        <>
          ...
          <Ariakit.Popover
            ...
            onPointerLeave={scheduleClose}
            className="border-border-light bg-surface-secondary text-text-primary z-50 w-80 max-w-[90vw] rounded-xl border p-2 shadow-lg outline-none"
          >
              ...
              {quotes.map((text, index) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="text-text-secondary hover:bg-surface-hover hover:text-text-primary focus-visible:ring-border-xheavy mt-0.5 shrink-0 rounded-full p-0.5 focus-visible:ring-2 focus-visible:outline-none"
                  >
                    <X className="h-3.5 w-3.5" aria-hidden="true" />
                  </button>
                </li>
