...
export default function DataTable<TData, TValue>({ columns, data }: DataTableProps<TData, TValue>) {
  ...
  return (
    <div className="flex h-full flex-col gap-4">
      ...
      <div className="border-border-light relative grid h-full max-h-[calc(100vh-20rem)] min-h-[calc(100vh-20rem)] w-full flex-1 overflow-hidden overflow-x-auto overflow-y-auto rounded-md border">
