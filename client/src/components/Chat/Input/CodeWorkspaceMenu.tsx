  ...
  return (
    <Ariakit.MenuProvider store={menuStore}>
      ...
      >
        ...
        <span className="max-w-[12rem] min-w-0 truncate">{label}</span>
        {canChoose && (
          <ChevronDown
            className={cn(
        ...
        >
          {workspace.environments.map(({ environment, state, workspaces, selected }) => (
            <div key={environment.id}>
              ...
              {workspaces.length === 0 && (
                <div className="text-text-secondary px-2.5 py-2 text-sm">
                ...
                return (
                  <Ariakit.MenuItemRadio
                    ...
                    className={cn(
                      ...
                      'duration-theme-fast transition-colors outline-none',
