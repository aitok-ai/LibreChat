  ...
  return (
    <div className="group mb-2.5 flex items-center gap-1 px-1">
      <ControlCombobox
        ...
        className="text-text-secondary hover:text-text-primary h-8 w-auto min-w-[11rem] gap-1.5 rounded-full px-2.5 text-sm font-medium"
      />
      <TooltipAnchor
        ...
        render={
          <button
            ...
            className="text-text-secondary hover:bg-surface-hover hover:text-text-primary focus-visible:ring-ring-primary flex h-7 w-7 shrink-0 items-center justify-center rounded-full opacity-0 transition-all outline-none group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2"
          >
