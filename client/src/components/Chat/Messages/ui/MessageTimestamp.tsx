...
function TimestampText({ timestamp }: { timestamp: Timestamp }) {
  return (
    <time
      ...
      className="text-text-secondary ml-2 text-xs font-normal transition-opacity duration-200 group-focus-within:opacity-100 group-hover:opacity-100 [@media(hover:hover)]:opacity-0"
    >
