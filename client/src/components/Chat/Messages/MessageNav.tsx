  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="flex min-h-0 w-14 cursor-pointer touch-none flex-col items-stretch gap-1.5 overflow-y-auto select-none [&::-webkit-scrollbar]:hidden"
      ...
      {tip &&
        createPortal(
          <div
            ...
            className="border-border-medium bg-surface-secondary text-text-secondary pointer-events-none max-w-[280px] rounded-md border px-3 py-2 shadow-lg"
          >
