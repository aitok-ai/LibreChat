    ...
    <HoverCard openDelay={150}>
      ...
      <HoverCardPortal>
        <HoverCardContent side="left" sideOffset={12} className="z-[999] max-w-[280px] px-3 py-2">
          <p className="text-text-secondary line-clamp-3 text-xs">{entry.preview}</p>
        </HoverCardContent>
      </HoverCardPortal>
    </HoverCard>
  );
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="flex min-h-0 cursor-grab touch-none flex-col items-center gap-1.5 overflow-y-auto select-none active:cursor-grabbing [&::-webkit-scrollbar]:hidden"
