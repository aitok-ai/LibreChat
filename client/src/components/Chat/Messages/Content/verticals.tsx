        ...
        return (
          ...
          <li key={`${imageSource(image) ?? ''}|${href ?? ''}|${i}`} className="shrink-0">
            <a
              ...
              className="border-border-light focus-visible:ring-border-heavy block h-28 overflow-hidden rounded-xl border no-underline focus-visible:ring-2 focus-visible:outline-none"
      ...
      {items.slice(0, MAX_VERTICAL_ITEMS).map((item, i) => (
        ...
        >
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="border-border-light hover:bg-surface-hover focus-visible:ring-border-heavy flex w-full flex-col rounded-xl border p-2 no-underline transition-colors focus-visible:ring-2 focus-visible:outline-none"
          >
      ...
      {places.slice(0, MAX_PLACES).map((place, i) => (
        ...
        >
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="hover:bg-surface-hover focus-visible:ring-border-heavy flex items-center gap-2.5 px-3 py-2 no-underline transition-colors focus-visible:ring-2 focus-visible:outline-none"
          >
