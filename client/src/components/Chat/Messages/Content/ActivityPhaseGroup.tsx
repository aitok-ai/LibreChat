      ...
      <div style={headerStyle}>
        <div className="overflow-hidden">
          <Button
            ...
            className="text-text-secondary hover:text-text-primary focus-visible:ring-border-heavy inline-flex h-auto min-h-7 w-full items-center justify-start gap-2 rounded-none bg-transparent p-0 py-1 text-left font-medium hover:bg-transparent focus-visible:ring-2 focus-visible:ring-offset-0 focus-visible:outline-none focus-visible:ring-inset"
