...
export default function ActivityPhaseGroup({
  ...
  const group = !hasContent ? (
    <div
      className={cn(
        'border-border-light bg-surface-secondary/40 text-text-secondary my-2 flex min-h-10 w-full items-center rounded-lg border px-3 py-2',
      ...
      <div style={headerStyle}>
        <div className="overflow-hidden">
          <Button
            variant="ghost"
            type="button"
            className="text-text-secondary hover:bg-surface-hover hover:text-text-primary focus-visible:ring-ring-primary flex h-auto min-h-10 w-full items-center justify-start gap-2 rounded-lg bg-transparent px-3 py-2 text-left focus-visible:ring-2 focus-visible:ring-offset-0 focus-visible:ring-inset"
