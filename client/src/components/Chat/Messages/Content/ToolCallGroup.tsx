...
export default function ToolCallGroup({
  ...
  return (
    <div className="mt-1 mb-2">
      <button
        type="button"
        className="text-text-secondary focus-visible:ring-border-heavy inline-flex w-full items-center gap-2 py-1 focus-visible:ring-2 focus-visible:outline-none"
      ...
      >
        {allSubagents ? (
          ...
          <div
            className={cn(
              ...
              !allCompleted && isSubmitting && 'text-primary animate-pulse',
            )}
            aria-hidden="true"
          >
            <Users size={14} />
        ...
        {toolNameSummary && !allSubagents && (
          <span className="text-text-secondary text-xs font-normal">— {toolNameSummary}</span>
        )}
        <ChevronDown
          className={cn(
