      ...
      <div className="group/thinking flex w-full items-center justify-between gap-2">
        ...
        {content && showCopyButton && (
          <Button
            ...
            className={cn(
              'text-text-secondary-alt size-auto gap-0 rounded-lg p-1.5',
              isExpanded
                ? 'opacity-0 group-focus-within/thinking-container:opacity-100 group-hover/thinking-container:opacity-100'
                : 'opacity-0',
              'hover:bg-surface-hover hover:text-text-primary',
              'focus-visible:ring-text-primary focus-visible:opacity-100 focus-visible:ring-2 focus-visible:outline-none',
            )}
          >
  ...
  return (
    <div className="mb-2 pt-2 pb-2">
      ...
      >
        ...
        <span className="text-text-secondary min-w-0 truncate text-left">{label}</span>
      </div>
    </div>
  );
});
