  ...
  return (
    ...
    >
      ...
      <div className="user-turn relative flex w-11/12 flex-col">
        <h2 className={cn('flex items-center gap-1.5 font-semibold select-none', fontSize)}>
          {label}
          ...
          <span
            ...
            className="transition-opacity duration-200 group-hover:opacity-100 focus-within:opacity-100 [@media(hover:hover)]:opacity-0"
          >
