...
const PreviewPlaceholderCard = memo(
  ({
    ...
    return (
      <div className="group text-text-primary relative my-2 inline-flex max-w-fit items-stretch gap-px overflow-hidden rounded-xl text-sm shadow-sm">
        <div
          aria-disabled="true"
          aria-busy={status === 'pending'}
          className="border-border-light bg-surface-tertiary relative overflow-hidden rounded-l-xl"
          ...
          <div className="w-fit p-2">
            <div className="flex flex-row items-center gap-2">
              ...
              <div className="overflow-hidden text-left">
                ...
                <div className="text-text-secondary flex items-center gap-1.5 truncate text-xs">
                  {status === 'pending' ? (
        ...
        <button
          ...
          className={cn(
            ...
            'bg-surface-tertiary text-text-secondary hover:bg-surface-hover hover:text-text-primary rounded-r-xl',
            'border-border-light focus-visible:ring-border-heavy border-l focus-visible:ring-2 focus-visible:outline-none',
          )}
        >
            ...
            <div className="border-border-light flex items-center justify-between gap-2 border-b px-3 py-2">
              ...
              {attachment.filepath && (
                <button
                  ...
                  aria-label={`${localize('com_ui_download')} ${visibleFilename}`}
                  title={localize('com_ui_download')}
                  className="text-text-secondary hover:bg-surface-hover hover:text-text-primary focus-visible:ring-border-heavy flex size-7 shrink-0 items-center justify-center rounded-md transition-colors focus-visible:ring-2 focus-visible:outline-none"
                >
                  <Download className="size-4" aria-hidden="true" />
                </button>
              )}
          ...
          <div className="p-4">
            ...
            {overflowed && (
              <button
                ...
                aria-controls={preId}
                className="text-text-secondary hover:text-text-primary focus-visible:ring-border-heavy mt-2 text-xs transition-colors focus-visible:ring-2 focus-visible:outline-none"
              >
