          ...
          <div className="relative mt-3">
            {!isAtBottom && (
              <button
                ...
                className="border-border-light bg-surface-secondary text-text-secondary hover:bg-surface-tertiary hover:text-text-primary absolute right-6 bottom-3 z-10 flex h-8 w-8 items-center justify-center rounded-full border shadow-md transition"
              >
