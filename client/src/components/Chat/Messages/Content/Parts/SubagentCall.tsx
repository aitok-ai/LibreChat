          ...
          <div className="border-border-light bg-surface-primary relative min-h-0 flex-1 border-t">
            {!isAtBottom && (
              <Button
                ...
                className="border-border-light bg-surface-secondary text-text-secondary hover:bg-surface-tertiary hover:text-text-primary absolute right-4 bottom-3 z-10 h-8 w-8 rounded-full border shadow-md transition"
              >
