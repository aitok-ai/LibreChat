  ...
  return (
    <div className="group text-text-primary relative my-2 inline-flex max-w-fit items-stretch gap-px overflow-hidden rounded-xl text-sm shadow-sm">
      <button
        ...
        className={cn(
          'hover:bg-surface-hover relative overflow-hidden rounded-l-xl transition-all duration-200 active:scale-[0.99]',
          {
        ...
        <div className="w-fit p-2">
          <div className="flex flex-row items-center gap-2">
            ...
            <div className="overflow-hidden text-left">
              ...
              <div className="text-text-secondary truncate text-xs">{actionLabel}</div>
            </div>
          </div>
        </div>
      </button>
