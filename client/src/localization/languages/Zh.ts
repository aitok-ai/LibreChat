...
export default {
  ...
  com_ui_video: '视频',
  com_ui_video_enable_hint: '启用视频生成',
  com_ui_video_enable: '启用视频',
  com_ui_video_enable_desc: '使用素材生成短视频',
  com_ui_video_template: '模板',
  com_ui_video_platform: '平台',
  com_ui_video_template_talking_head: '口播/解说',
  com_ui_video_template_product_review: '种草/好物推荐',
  com_ui_video_template_storyboard: '剧情/分镜剪辑',
  com_ui_video_template_image_mix: '图文混剪',
  com_ui_video_template_broll_subtitles: 'B-roll + 字幕',
  com_ui_video_template_beat_cut: '节奏卡点剪辑',
  com_ui_video_platform_douyin: '抖音',
  com_ui_video_platform_tiktok: 'TikTok',
  com_ui_video_platform_xiaohongshu: '小红书',
  com_ui_video_platform_youtube_shorts: 'YouTube Shorts',
  com_ui_video_job_status: '任务 {0} · {1} {2}',
  com_ui_video_job_pending: '等待中',
  com_ui_video_download_zip: '下载 ZIP',
  com_ui_video_assets_required: '请先附加视频、音频或图片素材。',
  com_ui_video_uploading_assets: '请等待所有文件上传完成后再提交。',
  com_ui_video_job_failed: '视频任务启动失败。',
  com_ui_video_stream_disconnected: '视频任务流已断开。',
